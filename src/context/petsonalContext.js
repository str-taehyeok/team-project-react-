  ...
  const value = {
    ...
    result : {
      ...
      Gradation : {
        ...
        imageSrc : "/assets/images/petsonal/gradation-result.png",
        title : "똥꼬발랄 사랑둥이"
      },
      LightPurple : {
        ...
        boxColor : "rgba(207, 165, 203, 0.7)",
        imageSrc : "/assets/images/petsonal/light-purple-result.png",
        title : "똥꼬발랄 사랑둥이"
      },
      SkyBlue : {
      ...
      DustySilver : {
        ...
        boxColor : "linear-gradient(to bottom, #89A9C4 20%, #42555E 100%)",
