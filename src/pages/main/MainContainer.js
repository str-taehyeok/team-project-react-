    ...
    <>
      ...
      <S.SwiperContainer>
        ...
        >
          <SwiperSlide>
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/layout/banner1.png`}
              alt="메인배너1"
            />
          </SwiperSlide>
          <SwiperSlide>
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/layout/banner2.png`}
              alt="메인배너2"
            />
          </SwiperSlide>
          <SwiperSlide>
            <img
              src={`${process.env.PUBLIC_URL}/assets/images/layout/banner3.png`}
              alt="메인배너3"
            />
          </SwiperSlide>
        </Swiper>
