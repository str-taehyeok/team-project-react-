            ...
            <form action="admin-coupon-write-ok.admin" method="POST" id="frame">
                ...
                <S.Container>
                    ...
                    <S.Box1>
                        ...
                        <S.Input type="text" id="eventTitle" name="adminCouponTitle" placeholder="ex) 쿠폰이벤트 기획전 -1" required/>
                    </S.Box1>

                    <S.Box1>
                        <S.Label htmlFor="coupon-code">쿠폰 코드</S.Label>
                        <S.Input
                            type="text" id="coupon-code" name="adminCouponCode" placeholder="쿠폰 번호 16자리를 입력해 주세요. '-'제외" maxLength="16" required/>
                    </S.Box1>
                ...
                <S.Box1>
                    <S.CouponWriteBtn>저장</S.CouponWriteBtn>
                </S.Box1>
